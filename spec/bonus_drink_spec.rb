...
describe BonusDrink do
  ...
  specify { expect(BonusDrink.total_count_for(1.1)).to eq 1 }
  specify { expect(BonusDrink.total_count_for(1.5)).to eq 1 }
  specify { expect(BonusDrink.total_count_for(3)).to eq 4 }
  specify { expect(BonusDrink.total_count_for(11)).to eq 16 }
  specify { expect(BonusDrink.total_count_for(11.1)).to eq 16 }
  specify { expect(BonusDrink.total_count_for(11.5)).to eq 16 }
end